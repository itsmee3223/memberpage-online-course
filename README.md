...
<p align='center'>
This is the frontend web, build with React, and deployed with <a href='https://vercel.com/ target='_blank'>Vercel</a>
</p>
...
<img src='https://res.cloudinary.com/dniq91ewn/image/upload/v1672062949/BWA%20Microservices/Sign_In_pfy3fw.png' width='45%'> &nbsp; &nbsp; &nbsp; &nbsp; <img src='https://res.cloudinary.com/dniq91ewn/image/upload/v1672062950/BWA%20Microservices/Sign_Up_sgogke.png'  width='45%'>

<img src='https://res.cloudinary.com/dniq91ewn/image/upload/v1672062947/BWA%20Microservices/Dashboard_User_Pic_nvx9vx.png' width='45%'> &nbsp; &nbsp; &nbsp; &nbsp; <img src='https://res.cloudinary.com/dniq91ewn/image/upload/v1672062946/BWA%20Microservices/Transaction_mcrjrh.png'  width='45%'>

<img src='https://res.cloudinary.com/dniq91ewn/image/upload/v1672062948/BWA%20Microservices/Settings_d9fwif.png' width='45%'> &nbsp; &nbsp; &nbsp; &nbsp; <img src='https://res.cloudinary.com/dniq91ewn/image/upload/v1672062947/BWA%20Microservices/Class_Room_chqb6v.png'  width='45%'>
...
3. Create a .env file inside the root folder and provide the following environment variables or you can look in the .env.example file:
    ...
    ```
    PORT= <client port>
    REACT_APP_BASE_URL = <this client url>
    REACT_APP_FRONTPAGE_URL = <frontpage url>
    REACT_APP_API_HOST = <api gateway url>
    ```
